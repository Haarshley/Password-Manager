...
lbl1=tk.Label(window,text="Website",bg="sandybrown",font=("arial",10,"bold"))
...
lbl2=tk.Label(window,text="E-Mail",bg="sandybrown",font=("arial",10,"bold"))
...
lbl3=tk.Label(window,text="Password",bg="sandybrown",font=("arial",10,"bold"))
